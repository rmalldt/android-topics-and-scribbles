...
class StorageTypesActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (isExternalStorageWritable() && isExternalStorageReadable()) {
            toastMessage(this, "External storage dirs available for read and write")
        }
    ...
    private fun writeFile(parent: File, child: String?) {
        binding.apply {
            ...
            if (fileName.isNotBlank() && fileContent.isNotBlank()) {
                ...
                toastMessage(this@StorageTypesActivity, "Please enter both file name and file content")
            }
        }
    }
    ...
    private fun readFile(parent: File, child: String?) {
        ...
        if (fileName.isNotBlank()) {
            ...
            toastMessage(this, "Please enter file name")
        }
    }
